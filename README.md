...
Git command to clone this subset: `git clone --branch subset-f9fe1b65a812847ca5c8535f5cef780d09f8e4ed --single-branch https://github.com/AntilatencySDK/Release_3.5.1.git AntilatencySDK`
